...
namespace linked_list_ontap_MXNhan
{
    internal class khachhang
    {
       ...
       public int  CS_tieuthusau { get; set; }
        ...
        public khachhang( string MaKH, string hoten, string diachi, int CS_tieuthutrc, int CS_tieuthusau)
        {
            this.MaKH = MaKH;
            this.hoten = hoten;
            this.diachi = diachi;
        ...
        public khachhang(string line)
        {
            ...
            this.hoten = s[1];
            this.diachi = s[2];
            this.CS_tieuthutrc = int.Parse(s[3]);
            this.CS_tieuthusau = int.Parse(s[4]);
        }

        public override string ToString()
        {
            return string.Format ("{0,-7}|{1,-25}|{2,-25}|{3,25}|{4,8}|{5,9}|{6,8}", MaKH, hoten, diachi, CS_tieuthutrc, CS_tieuthusau,CS_TieuThu, sotientra);
        }
    }
